...
public class EnemyMove : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            //　水平面での移動を考えるのでXZのみ扱う.
            Vector3 destinationXY = destination;
            destinationXY.z = transform.position.z;// 高さを目的地と現在地を同じにしておく.

            //********* ここからXZのみで考える. ********
            // 目的地までの距離と方角を求める.
            Vector2 direction = (destinationXY - transform.position).normalized;
            float distance = Vector3.Distance(transform.position, destinationXY);
